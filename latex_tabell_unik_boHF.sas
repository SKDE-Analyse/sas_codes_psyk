%macro latex_tabell_unik_boHF(inndata=phvtsb1517, opptak=1, navn_opptak=Finnmark, innb=innbyggere_1517);
...
select distinct BehHF_type, SUM(inn_unik_aar_i) as tot_inn, SUM(poli_unik_aar_i) as tot_poli

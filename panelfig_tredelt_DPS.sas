...
/*Grupperer til pasientdager og institusjonsopphold, aggregerer.*/
%aggreger_psyk_DA(inndata=&del3, utdata=agg3, agg_var=alle, ut_boHF=0, ut_BehHF=0, ut_boDPS=1);
...
/*Grupperer til pasientdager og institusjonsopphold, aggregerer.*/
%aggreger_psyk_DA(inndata=&tot, utdata=agg4, agg_var=alle, ut_boHF=0, ut_BehHF=0, ut_boDPS=1);
